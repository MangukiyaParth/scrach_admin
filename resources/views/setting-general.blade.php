                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        @csrf
                            ...
                            <div class="form-group row">
                                <label for="exampleInputEmail2" class="col-sm-3 col-form-label">{{ __('App Support Email')}}</label>
                                <div class="col-sm-9">
                                    <input id="version" type="email" class="form-control" name="app_email" value="{{$data[0]->app_email}}" placeholder="support@email.com" required>
                                     </div>
                             </div>
